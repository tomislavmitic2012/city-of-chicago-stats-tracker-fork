...
public class PotholesReportedJob implements Job {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PotholesReportedJob.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        HttpGet httpGet = new HttpGet(String.format(props.getProperty("socrata_potholes_url"),
                dates[0], dates[1]));
        ...
        try {
            ...
            JobUtils.writeToMongoDB(jsonStr, "socrata_potholes_collection", "pothole_id_key");
